...
class TestPythonModule:
    ...
    def test_from_imported_module(self):
        ...
        assert 'withabstract' == module.name
        assert 'tests.modules.withabstract' == module.fully_qualified_name
        assert MODULES_DIR / 'withabstract.py' == module.path
    ...
    def test_visit(self):
        ...
        assert expected_class_names == actual_class_names  # FIXME: test more than classes name
    ...
    def test_visit_3(self):
        ...
        module.visit()
        assert 5 == len(module.import_statements)
    ...
    def test_has_classes_3(self):
        ...
        module.visit()
        assert not module.has_classes

    def test_resolve_class_name(self, module):
        """ Test resolve_class_name """
        expected_fqn = 'tests.modules.withmethods.withmethods.Point'
        actual_fqn = module.resolve_class_name('Point')
        assert expected_fqn == actual_fqn

    def test_resolve_class_name_alias(self, module):
        """ Test resolve_class_name with an aliased class."""
        expected_fqn = 'tests.modules.withmethods.withmethods.Point'
        actual_fqn = module.resolve_class_name('Pt')
        assert expected_fqn == actual_fqn

    def test_resolve_class_pqn(self, module):
        ...
        actual_fqn = module.resolve_class_pqn('withmethods.withmethods.Coordinates')
        assert expected_fqn == actual_fqn

    def test_resolve_class_pqn_alias(self, module):
        """ Test resolve_class_pqn on an aliased partially defined class name with relative import """
        expected_fqn = 'tests.modules.withmethods.withmethods.Coordinates'
        actual_fqn = module.resolve_class_pqn('withmeth.withmethods.Coordinates')
        assert expected_fqn == actual_fqn
...
class TestModuleVisitor:
    ...
    def test_visit(self):
        ...
        assert expected_imports == visitor.imports
...
class TestModuleImport:
    ...
    def test_resolve_relative_import(self):
        ...
        assert expected_result == module_import.fully_qualified_name
